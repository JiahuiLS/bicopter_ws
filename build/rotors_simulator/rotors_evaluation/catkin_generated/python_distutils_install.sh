...
echo_and_run cd "/home/hui/bicopter_ws/src/rotors_simulator/rotors_evaluation"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/hui/bicopter_ws/src/rotors_simulator/rotors_evaluation/setup.py" \
     \
    build --build-base "/home/hui/bicopter_ws/build/rotors_simulator/rotors_evaluation" \
    install \
    --root="${DESTDIR-/}" \
